...
const AnimatedText = styled(DescText)`
  ...
  animation: slide 16s linear infinite; // Customize timing 
    ...
    <BgPage padding="0">
      <div style={{ position: 'relative', zIndex: 2 }}>
        <div style={{ margin: '0rem 0', padding: window.innerWidth <= 768 ? '0rem' : '8rem', paddingTop: window.innerWidth <= 768 ? '5rem' : '8rem', }}>
          ...
          <div style={{ display: 'inline-grid',  justifyContent: 'space-around', flexWrap: 'wrap', paddingRight: window.innerWidth <= 768 ? '0rem' : '20rem', paddingLeft: window.innerWidth <= 768 ? '0rem' : '5rem', paddingTop: window.innerWidth <= 768 ? '4rem' : '3rem', paddingBottom: window.innerWidth <= 768 ? '2rem' : '3rem'}}>
            <DescTextContainer>
